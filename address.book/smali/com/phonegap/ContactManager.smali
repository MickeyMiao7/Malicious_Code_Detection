...
# instance fields
.field private contactAccessor:Lcom/phonegap/ContactAccessor;
...
.method public execute(Ljava/lang/String;Lorg/json/JSONArray;Ljava/lang/String;)Lcom/phonegap/api/PluginResult;
    ...
    sget-object v8, Lcom/phonegap/api/PluginResult$Status;->ERROR:Lcom/phonegap/api/PluginResult$Status;

    invoke-direct {v7, v8, v3}, Lcom/phonegap/api/PluginResult;-><init>(Lcom/phonegap/api/PluginResult$Status;Lorg/json/JSONObject;)V
    ...
    .end local v3    # "res":Lorg/json/JSONObject;
    :cond_0
    iget-object v7, p0, Lcom/phonegap/ContactManager;->contactAccessor:Lcom/phonegap/ContactAccessor;

    if-nez v7, :cond_1

    .line 82
    new-instance v7, Lcom/phonegap/ContactAccessorSdk5;

    iget-object v8, p0, Lcom/phonegap/ContactManager;->webView:Landroid/webkit/WebView;

    iget-object v9, p0, Lcom/phonegap/ContactManager;->ctx:Lcom/phonegap/api/PhonegapActivity;

    invoke-direct {v7, v8, v9}, Lcom/phonegap/ContactAccessorSdk5;-><init>(Landroid/webkit/WebView;Landroid/app/Activity;)V

    iput-object v7, p0, Lcom/phonegap/ContactManager;->contactAccessor:Lcom/phonegap/ContactAccessor;
    ...
    invoke-virtual {v7, v8, v9}, Lcom/phonegap/ContactAccessor;->search(Lorg/json/JSONArray;Lorg/json/JSONObject;)Lorg/json/JSONArray;
    ...
    const-string v8, "navigator.contacts.cast"

    invoke-direct {v7, v6, v3, v8}, Lcom/phonegap/api/PluginResult;-><init>(Lcom/phonegap/api/PluginResult$Status;Lorg/json/JSONArray;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-virtual {v7, v8}, Lcom/phonegap/ContactAccessor;->save(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-virtual {v7, v1}, Lcom/phonegap/ContactAccessor;->getContactById(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-direct {v7, v6, v3}, Lcom/phonegap/api/PluginResult;-><init>(Lcom/phonegap/api/PluginResult$Status;Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v7, v8}, Lcom/phonegap/ContactAccessor;->remove(Ljava/lang/String;)Z
    ...
    invoke-direct {v7, v8, v2}, Lcom/phonegap/api/PluginResult;-><init>(Lcom/phonegap/api/PluginResult$Status;Lorg/json/JSONObject;)V
    :try_end_3
